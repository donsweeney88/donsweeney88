...
public class TEnmoController {
    ...
    @RequestMapping(value = "/transfer_details/{transferId}", method = RequestMethod.GET)
    public Transaction transferDetails(@PathVariable int transferId) throws TransactionException {
       return userDao.getTransferDetails(transferId);
    }
    // used in App sorting and printing usernames in console
    ...
    // gets in prints username in view transfers report
